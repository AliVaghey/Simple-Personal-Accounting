<x-layouts.main>
    ...
    <div x-data="{modal: false}">
        <div class="flex flex-col gap-11">
            <div class="w-11/12 mx-auto pt-4 relative flex items-center">
                <div class="border cursor-pointer border-white size-9 flex justify-center items-center rounded-xl">
                     <button @click="modal = true" class="border cursor-pointer border-white size-9 flex justify-center items-center rounded-xl">
        ...
        <div x-show="modal" id="add-tag-dialog" class="fixed inset-0 flex backdrop-blur-md justify-center items-center" @click="modal = false">
