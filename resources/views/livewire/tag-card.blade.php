...
<div class="w-11/12 mx-auto h-24 rounded-xl flex flex-col justify-around items-center border" style="border-color: {{ $c }}; background-color: {{ $c . '10' }};">
    ...
    >
        <livewire:edit-tag-modal lazy :$tag />
    </div>
