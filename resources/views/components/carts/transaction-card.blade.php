<div @click="$dispatch('transaction-card-clicked', {id: {{ $trans->id }}})" {{ $attributes }} class="w-full border backdrop-blur-lg rounded-xl px-4 py-2 {{ !$trans->is_expense ? 'bg-green-500/10 border-green-500' : 'bg-red-500/10 border-red-500'  }}">
    ...
    <div class="flex flex-wrap justify-between gap-2 items-center  px-3 ">
