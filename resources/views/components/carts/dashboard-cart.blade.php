 <div class="w-11/12  mx-auto border border-white rounded-lg backdrop-blur-xl">
        <p class="text-white text-center text-2xl py-4">امروز</p>
        <div class="flex justify-between items-center gap-4 w-11/12 mx-auto">
            <div class="flex flex-col gap-4">
                <div class="flex justify-center items-center gap-2">
                    ...
                    <span class="text-green-500 text-xl">200,000,000</span>
                </div>
                <div>
                    <div class="flex justify-center items-center gap-2">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="text-red-500 text-xl">200,000,000</span>
                    </div>
                </div>
            </div>
            <div class="w-32 h-32 rounded-full bg-rose-300"></div>
        </div>
        <div class="flex items-center gap-4 w-11/12 mx-auto my-4">
            <div class="h-8 border border-white rounded-xl bg-white/25 px-3 flex justify-between items-center gap-1.5"><span class="text-white text-xs">10%</span><span class="text-white text-xs">تگ اول</span></div>
            <div class="h-8 border border-red-500 rounded-xl bg-red-500/25 px-3 flex justify-between items-center gap-1.5"><span class="text-white text-xs">10%</span><span class="text-white text-xs">تگ دوم</span></div>
        </div>
    </div>